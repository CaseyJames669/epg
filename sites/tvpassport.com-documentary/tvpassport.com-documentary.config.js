...
module.exports = {
  site: 'tvpassport.com-documentary',
  days: 3,
  url({ channel, date }) {
  ...
  async channels() {
    ...
    {
        'lang': 'en',
        'site_id': 'cgtn-documentary-english/36353',
    ...
    {
        'lang': 'en',
        'site_id': '360-north-gavel-to-gavel/9460',
        'name': '360 North (Gavel to Gavel)'
    },
    {
        'lang': 'en',
        'site_id': 'channel-i-bangladesh/14202',
